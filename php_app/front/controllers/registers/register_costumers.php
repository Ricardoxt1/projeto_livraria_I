                                            ...
                                            <div class="row g-3">
                                                <div class="col-sm-7">
                                                    ...
                                                    <input type="text" class="form-control" name="name"
                                                        id="nome_costumer" placeholder="fulano da silva " value=""
                                                        required="">
                                                ...
                                                <div class="col-sm-5">
                                                    ...
                                                    <input type="number" class="form-control" name="phone_number"
                                                        id="numero_costumer" placeholder="(00) 0000-0000" value=""
                                                        required="">
                                                    <div class="invalid-feedback">
                                                ...
                                                <div class="col-sm-7">
                                                    <label for="email_costumer" class="form-label">Email <span
                                                            class="text-body-secondary">(Optional)</span></label>
                                                    <input type="email" class="form-control" name="email"
                                                        id="email_costumer" placeholder="you@example.com">
                                                    <div class="invalid-feedback">
                                                ...
                                                <div class="col-sm-5">
                                                    ...
                                                    <input type="number" class="form-control" name="cpf"
                                                        id="cpf_costumer" placeholder="123.456.789-09" max="14" value=""
                                                        required="">
                                                    <div class="invalid-feedback">
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <input type="text" class="form-control" name="address"
                                                        id="address_costumer" placeholder="Main ST 1234" required="">
                                                    <div class="invalid-feedback">
