                        ...
                        <!-- <form action='../../../pdo/list/list_rentals.php' method='get'>
                            <tbody>
                                <tr> -->
                                    ...
                                    //         echo "<td name='id_costumers_rentals'>$row_costumers[name]</td>";
                                    //     }
                                    // } else {
                                    //     echo "<p style='color:red;'>Não foi realizadar a listagem com sucesso.</p>";
                                    // };
                                    ?>
                                    <!-- <td name='id_book_rentals'>$row_rentals[book_id]</td>
                                    <td name='rental'>$row_rentals[rental]</td>
                                    <td name='delivey'>$row_rentals[delivery]</td>
                                    <td name='id_employee_rentals'>$row_rentals[employee_id]</td>
                                    <td name='edit_name'><a href='../edit/edit_rentals.php'><svg xmlns='http://www.w3.org/2000/svg' width='18' height='18' fill='currentColor' class='bi bi-pencil-square' viewBox='0 0 16 16'>
                                                <path d='M15.502 1.94a.5.5 0 0 1 0 .706L14.459 3.69l-2-2L13.502.646a.5.5 0 0 1 .707 0l1.293 1.293zm-1.75 2.456-2-2L4.939 9.21a.5.5 0 0 0-.121.196l-.805 2.414a.25.25 0 0 0 .316.316l2.414-.805a.5.5 0 0 0 .196-.12l6.813-6.814z' />
                                                <path fill-rule='evenodd' d='M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5v11z' />
                                            </svg>
                                        </a>
                                    <td name='delete_name'><a href='../delete/delete_rentals.php'><svg xmlns='http://www.w3.org/2000/svg' width='18' height='18' fill='currentColor' class='bi bi-trash' viewBox='0 0 16 16'>
...
<!-- 
                        ...
                        <?php
                        $query_rentals = "SELECT costumer_id, book_id, rental, delivery, employee_id FROM rentals";
                        ...
                        if (($result_rentals) and ($result_rentals->rowCount() != 0)) {
                            while ($row_rentals = $result_rentals->fetch(PDO::FETCH_ASSOC)) {
                                ...
                                <form action='../../../pdo/list/list_rentals.php' method='get'>
                                    <tbody>
                                        <tr>
                                            <td name='id_costumers_rentals'>$row_rentals[costumer_id]</td>
                                            <td name='id_book_rentals'>$row_rentals[book_id]</td>
                                            <td name='rental'>$row_rentals[rental]</td>
                                            <td name='delivey'>$row_rentals[delivery]</td>
                                            <td name='id_employee_rentals'>$row_rentals[employee_id]</td>
