                                ...
                                <form action='../../../pdo/list/list_authors.php' method='get'>
                                    <tbody>
                                        <tr>
                                            ...
                                            <td name='edit_name'><a href='../edit/edit_authors.php?id=$row_authors[id]'><svg xmlns='http://www.w3.org/2000/svg' width='18' height='18' fill='currentColor' class='bi bi-pencil-square' viewBox='0 0 16 16'>
                                                ...
                                                <td name='delete_name'><a href='../delete/delete_authors.php?id=$row_authors[id]'><svg xmlns='http://www.w3.org/2000/svg' width='18' height='18' fill='currentColor' class='bi bi-trash' viewBox='0 0 16 16'>
