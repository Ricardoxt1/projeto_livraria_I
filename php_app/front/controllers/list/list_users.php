    ...
    <header class="navbar navbar-dark sticky-top bg-primary flex-md-nowrap p-0 shadow">
        ...
        <div class="navbar-nav">
            <div class="nav-item text-nowrap">
                <a class="nav-link px-3" href="../../controllers/">Voltar ao menu</a>
            </div>
        </div>
    </header>
            ...
            <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
                <div class="position-sticky pt-3 sidebar-sticky">
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="../list/list_books.php">
                                <span data-feather="list_users" class="align-text-bottom"></span>
                                Livros
                            </a>

                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="../controllers/list_authors.php">
                                <span data-feather="list_users" class="align-text-bottom"></span>
                                Autores
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="../controllers/list_costumers.php">
                                <span data-feather="leitores" class="align-text-bottom"></span>
                                Consumidores
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="../../pdo/registers/register_rentals.php">
                    ...
                    <ul class="nav flex-column mb-2">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="../controllers/edit_users.php">
                                <span data-feather="file-text" class="align-text-bottom"></span>
                                Editar itens
                            </a>
                        </li>
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-sm">
                        ...
                        <form action="../../../pdo/list/list_costumers.php" method="get">
                            <tbody>
                                <tr>
                                    <td name="id_costumers">1</td>
                                    <td name="name_costumers">nome</td>
                                    <td name="phone_number_costumers">telefone</td>
                                    <td name="address_costumers">endereço</td>
